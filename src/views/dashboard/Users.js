...
import { apiGetUsers, apiDeleteUser } from "../../api/users";
...
const columns = [
    ...
    { field: 'image', headerName: 'Foto', type: 'filepath' },
    ...
    return (
        <>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog}>
                ...
                <DialogActions>
                    <Button onClick={handleCloseDialog} sx={{ backgroundColor: '#7B3F00', color: 'white' }}>
                        Anuleaza
                    </Button>
